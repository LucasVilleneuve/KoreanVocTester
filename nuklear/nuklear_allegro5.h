...
nk_allegro5_handle_event(ALLEGRO_EVENT *ev)
{
    ...
    switch (ev->type) {
        ...
        case ALLEGRO_EVENT_MOUSE_BUTTON_UP: {
            ...
            nk_input_button(ctx, (nk_buttons)button, ev->mouse.x, ev->mouse.y, ev->type == ALLEGRO_EVENT_MOUSE_BUTTON_DOWN);
        } break;
        ...
        case ALLEGRO_EVENT_TOUCH_END: {
            ...
            nk_input_button(ctx, (nk_buttons)NK_BUTTON_LEFT, (int)ev->touch.x, (int)ev->touch.y, ev->type == ALLEGRO_EVENT_TOUCH_BEGIN);
        } break;
